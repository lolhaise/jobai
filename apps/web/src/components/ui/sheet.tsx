...
// Sheet component for mobile navigation and overlay panels
...
// Sheet portal for rendering outside normal DOM tree
const SheetPortal = SheetPrimitive.Portal

// Overlay component with animation styles
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Overlay
    className={cn(
      // Base overlay styles with backdrop blur
      "fixed inset-0 z-50 bg-black/80 backdrop-blur-sm",
      // Animation classes for smooth fade in/out
...
// Variant definitions for sheet positioning and animations
  ...
  "fixed z-50 gap-4 bg-white p-6 shadow-lg transition ease-in-out",
  {
    variants: {
      side: {
        ...
        // Right slide sheet (most common for mobile nav)
        right: [
...
// Sheet title component with proper heading semantics
...
// Sheet description component for accessibility
